...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageWidget.setMinimumSize(QtCore.QSize(1080, 620))
        ...
        self.label.setMinimumSize(QtCore.QSize(1040, 0))
        self.label.setObjectName("label")
        self.imageLayout.addWidget(self.label, 0, QtCore.Qt.AlignHCenter)
        self.mainLayout.addWidget(self.imageWidget, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        self.mainLayout.addWidget(self.controlPanelWidget, 0, QtCore.Qt.AlignRight)
